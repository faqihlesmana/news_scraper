...
def parse_article(url: str) -> dict | None:
    ...
    # Pre-clean: remove "Bacaan Lainnya" related posts noise before extracting
    content_el = soup.select_one("[class*='entry-content']")
    if content_el:
        for aside in content_el.find_all(class_=re.compile(r"related|widget|nav")):
            aside.decompose()
